...
RSpec.describe PeepRepo do
  ...
  it 'returns a list of all peeps' do
    ...
    expect(peeps.first.author_name).to eq 'User 2'
    expect(peeps.first.author_username).to eq 'user2'
    ...
    expect(peeps.last.author_name).to eq 'User 1'
    expect(peeps.last.author_username).to eq 'user1'
  end
  ...
  it 'creates a new peep' do
    ...
    expect(peeps.first.author_name).to eq 'User 1'
    expect(peeps.first.author_username).to eq 'user1'
  end
end
